...
commands = [
    ...
    "pip install s5cmd",
    f"s5cmd sync s3://ai2-oe-data/jakep/olmocr/qwen2.5-vl-7b-olmocrv4_1epoch_promptv4_filtering_mix0925_preempt-8532/* /data/models/qwen2.5-vl-7b-olmocrv4_1epoch_promptv4_filtering_mix0925_preempt-8532/",
